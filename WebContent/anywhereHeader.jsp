...
<div id="back">
	...
	<ul id="menu">
		<li class="active" ><form method="post" name="form1" action="EmployeeListServlet">
		    ...
		    <a href="javascript:form1.submit()"><strong class="header">従業員一覧</strong><span>EmployeeList</span></a>
		</form></li>
		...
		<li class="active"><form method="post" name="form2" action="EmployeeRegistrationServlet">
		    ...
		    <a href="javascript:form2.submit()"><strong class="header">従業員情報登録</strong><span>EmployeeRegister</span></a>
		</form></li>
		<%} %>
		...
		<li class="active"><form method="post" name="form3" action="LicenseRegistrationServlet">
		    ...
		    <a href="javascript:form3.submit()"><strong class="header">保有資格追加</strong><span>LicenseRegister</span></a>
		</form></li>
		<li class="active"><form method="post" name="form4" action="LicenseAddServlet">
		    <input type="hidden" name="ACTION" value="新規資格追加">
		    <a href="javascript:form4.submit()"><strong class="header">新規資格追加</strong><span>LicenseAdd</span></a>
		</form></li>
		<%} %>
		...
		<li class="active"><form method="post" name="form5" action="ChangeLogServlet">
		    ...
		    <a href="javascript:form5.submit()"><strong class="header">情報の変更ログ</strong><span>ChangeLog</span></a>
		</form></li>
		...
		<li class="active"><form method="post" name="form6" action="UserRegistrationServlet">
		    ...
		    <a href="javascript:form6.submit()"><strong class="header">システム利用者追加</strong><span>UserAdd</span></a>
		</form></li>
		<%} %>

		<li class="active"><form method="post" name="form7" action="LogoutServlet">
		    <input type="hidden" name="ACTION" value="ログアウト">
		    <a href="javascript:form7.submit()"><strong class="header">ログアウト</strong><span>Logout</span></a>
		</form></li>
	</ul>
	</div>
<%} %>
